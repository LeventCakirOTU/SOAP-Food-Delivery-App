...
public class MainFrame extends JFrame {
    ...
    public MainFrame(UserService userService, RestaurantService restaurantService) {
        ...
        cardPanel.add(new DriverDashboardScreen(this, orderService, deliveryService), SCREEN_DRIVER_DASHBOARD);
    ...
    /** Load a restaurant's menu and navigate to the menu screen */
