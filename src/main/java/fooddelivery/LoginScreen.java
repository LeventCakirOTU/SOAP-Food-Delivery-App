...
public class LoginScreen extends JPanel {
    ...
    private void handleLogin(MainFrame frame, UserService userService) {
        ...
        com.fooddelivery.user.User user = userService.login(email, password);
        ...
        if (user instanceof com.fooddelivery.user.Customer) {
            frame.showScreen(MainFrame.SCREEN_CUSTOMER_DASHBOARD);
        } else if (user instanceof com.fooddelivery.user.Driver) {
            frame.showScreen(MainFrame.SCREEN_DRIVER_DASHBOARD);
        } else if (user instanceof com.fooddelivery.user.RestaurantOwner) {
